...
template <typename OopClosureType>
class OopOopIterateKluteDispatch : public AllStatic {
private:
  typedef void (*FunctionType)(OopClosureType*, oop, KlassLUTEntry);

  class Table {
  private:
    template <typename KlassType, typename T>
    static void oop_oop_iterate(OopClosureType* cl, oop obj, KlassLUTEntry klute) {
      KlassType::oop_oop_iterate<T>(obj, cl, klute);
    }

    template <typename KlassType>
    static void init(OopClosureType* cl, oop obj, KlassLUTEntry klute) {
      OopOopIterateKluteDispatch<OopClosureType>::_table.set_resolve_function_and_execute<KlassType>(cl, obj, klute);
    }
    ...
    template <typename KlassType>
    void set_resolve_function_and_execute(OopClosureType* cl, oop obj, KlassLUTEntry klute) {
      set_resolve_function<KlassType>();
      _function[KlassType::Kind](cl, obj, klute);
    }
...
template <typename OopClosureType>
typename OopOopIterateKluteDispatch<OopClosureType>::Table OopOopIterateKluteDispatch<OopClosureType>::_table;


template <typename OopClosureType>
class OopOopIterateKluteBoundedDispatch {
private:
  typedef void (*FunctionType)(OopClosureType*, oop, KlassLUTEntry, MemRegion);

  class Table {
  private:
    template <typename KlassType, typename T>
    static void oop_oop_iterate_bounded(OopClosureType* cl, oop obj, KlassLUTEntry klute, MemRegion mr) {
      KlassType::oop_oop_iterate_bounded<T>(obj, cl, klute, mr);
    }

    template <typename KlassType>
    static void init(OopClosureType* cl, oop obj, KlassLUTEntry klute, MemRegion mr) {
      OopOopIterateKluteBoundedDispatch<OopClosureType>::_table.set_resolve_function_and_execute<KlassType>(cl, obj, klute, mr);
    }
    ...
    template <typename KlassType>
    void set_resolve_function_and_execute(OopClosureType* cl, oop obj, KlassLUTEntry klute, MemRegion mr) {
      set_resolve_function<KlassType>();
      _function[KlassType::Kind](cl, obj, klute, mr);
    }
...
public:
  ...
  static FunctionType function(KlassLUTEntry klute) {
    return _table._function[klute];
  }
};

template <typename OopClosureType>
typename OopOopIterateKluteBoundedDispatch<OopClosureType>::Table OopOopIterateKluteBoundedDispatch<OopClosureType>::_table;


template <typename OopClosureType>
class OopOopIterateKluteBackwardsDispatch {
private:
  typedef void (*FunctionType)(OopClosureType*, oop, Klass*);
  ...
  private:
    template <typename KlassType, typename T>
    static void oop_oop_iterate_backwards(OopClosureType* cl, oop obj, KlassLUTEntry klute) {
      KlassType::oop_oop_iterate_reverse<T>(obj, cl, klute);
    }

    template <typename KlassType>
    static void init(OopClosureType* cl, oop obj, KlassLUTEntry klute) {
      OopOopIterateKluteBackwardsDispatch<OopClosureType>::_table.set_resolve_function_and_execute<KlassType>(cl, obj, klute);
    }
...
template <typename OopClosureType>
typename OopOopIterateKluteBackwardsDispatch<OopClosureType>::Table OopOopIterateKluteBackwardsDispatch<OopClosureType>::_table;


template <typename OopClosureType>
void OopIteratorClosureDispatch::oop_oop_iterate(OopClosureType* cl, oop obj, KlassLUTEntry klute) {
  OopOopIterateKluteDispatch<OopClosureType>::function(klute)(cl, obj, klute);
}

template <typename OopClosureType>
void OopIteratorClosureDispatch::oop_oop_iterate(OopClosureType* cl, oop obj, KlassLUTEntry klute, MemRegion mr) {
  OopOopIterateKluteBoundedDispatch<OopClosureType>::function(klute)(cl, obj, klute, mr);
}

template <typename OopClosureType>
void OopIteratorClosureDispatch::oop_oop_iterate_backwards(OopClosureType* cl, oop obj, KlassLUTEntry klute) {
  OopOopIterateKluteBackwardsDispatch<OopClosureType>::function(klute)(cl, obj, klute);
}
