...
size_t ShenandoahHeapRegion::setup_sizes(size_t max_heap_size) {
  ...
  // We don't want objects to suddenly become humongous during evacuation if
  // they grow by 1 word because of i-hash-code.
  HumongousThresholdWords = MIN2(HumongousThresholdWords, RegionSizeWords - 1);
